...
public class ModuleScreen extends Screen {
    ...
    private List<Module> getFilteredModules() {
        return BloomCore.MODULES.getModules().stream()
    ...
    public void render(DrawContext ctx, int mx, int my, float delta) {
        ...
        List<Module> allMods = BloomCore.MODULES.getModules();
        ...
        for (int i = 0; i < filtered.size(); i++) {
            ...
            int globalIdx = BloomCore.MODULES.getModules().indexOf(m);
        ...
        if (selectedModule >= 0 && selectedModule < BloomCore.MODULES.getModules().size()) {
            Module m = BloomCore.MODULES.getModules().get(selectedModule);
    ...
    public boolean mouseClicked(Click click, boolean bl) {
        ...
        for (int i = 0; i < filtered.size(); i++) {
            ...
            if (mx >= x && mx <= x + cardW && my >= y && my <= y + cardH) {
                int globalIdx = BloomCore.MODULES.getModules().indexOf(filtered.get(i));
